...
class solved extends Controller
{
	...
	protected function manage() : void
	{
		...
		else
		{
			...
			Output::i()->output = Theme::i()->getTemplate( 'global', 'core' )->tabs( $tabs, $activeTab, (string)$chart, Url::internal( "app=forums&module=stats&controller=solved" ), 'tab', '', 'i-padding_3' );
		}
	}
